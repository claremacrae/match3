...
CXX             := g++
CXXFLAGS        := -std=c++11 -Wall -Wextra -Werror -D BOOST_DI_NO_CXX11_FEATURES -Iinclude -I$(EXTERNALS)/boost_1_52_0 -I$(EXTERNALS)/SDL2-2.0.0/include -I$(EXTERNALS)/SDL2_image-2.0.0 -I$(EXTERNALS)/SDL_ttf-2.0.11 -I$(EXTERNALS)/di/include
LIBS            := -Lbin/linux -lSDL2 -lSDL2_image -lSDL2_ttf-2.0
